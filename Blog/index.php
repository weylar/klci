...
if (!isset($_GET['more'])) {
   ...
   if (isset($_GET['tag'])) {
      if ($_GET['tag'] === 'projects') {
         ...
         if ($currentpage > 1) {
            ...
            echo "<li><a href='index.php?tag=projects&currentpage=1'><<</a></li> ";
         ...
         if ($currentpage != $totalpages) {
            ...
            echo " <li><a href='index.php?tag=projects&currentpage=$totalpages'>>></a</li>";
         } echo "</ul>";
      }
   }
   if (isset($_GET['tag'])) {
      if ($_GET['tag'] === 'news') {
         ...
         if ($currentpage > 1) {
            // show << link to go back to page 1
            echo "<li><a href='index.php?tag=news&currentpage=1'><<</a></li> ";
            // get previous page num
            $prevpage = $currentpage - 1;
            // show < link to go back to 1 page
         ...
         if ($currentpage != $totalpages) {
            ...
            // echo forward link for lastpage
            echo " <li><a href='index.php?tag=news&currentpage=$totalpages'>>></a</li>";
         } 
         echo"</ul>";     
      }
   }
   ...
   if (isset($_GET['tag'])) {
      if ($_GET['tag'] === 'outreaches') {
         ...
         if ($currentpage > 1) {
            // show << link to go back to page 1
            echo "<li><a href='index.php?tag=outreaches&currentpage=1'><<</a></li> ";
            // get previous page num
            $prevpage = $currentpage - 1;
            // show < link to go back to 1 page
         ...
         if ($currentpage != $totalpages) {
            ...
            // echo forward link for lastpage
            echo " <li><a href='index.php?tag=outreaches&currentpage=$totalpages'>>></a</li>";
         } 
         echo "</ul>";
      ...
      if ($currentpage > 1) {
         // show << link to go back to page 1
         echo "<li><a href='index.php?currentpage=1'><<</a></li> ";
         // get previous page num
         $prevpage = $currentpage - 1;
         // show < link to go back to 1 page
      ...
      if ($currentpage != $totalpages) {
         ...
         // echo forward link for lastpage
         echo " <li><a href='index.php?currentpage=$totalpages'>>></a</li>";
      } // end if
      echo "</ul>";
